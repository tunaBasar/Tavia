...
const styles = StyleSheet.create({
  ...
  promoBtn:{backgroundColor:'#6C63FF',borderRadius:12,paddingHorizontal:20,justifyContent:'center',shadowColor:'#6C63FF',shadowOffset:{width:0,height:4},shadowOpacity:0.3,shadowRadius:8,elevation:6},
  ...
  couponLeft:{width:72,backgroundColor:'rgba(108,99,255,0.1)',alignItems:'center',justifyContent:'center',paddingVertical:16},
  discountBadge:{backgroundColor:'#6C63FF',borderRadius:8,paddingHorizontal:8,paddingVertical:4},discountBadgeUsed:{backgroundColor:'rgba(255,255,255,0.15)'},
  ...
  couponFooter:{flexDirection:'row',justifyContent:'space-between',marginTop:8},couponCode:{fontSize:11,fontWeight:'700',color:'#6C63FF',letterSpacing:0.5},couponExpiry:{fontSize:10,color:'rgba(255,255,255,0.25)'},
});
